...
image: "/images/responsive/hero-blog.png"
excerpt: "Webpages and apps need totally different URL strategies. Mix them up and you break SEO — or create absurd edge cases nobody can answer."
description: "Webpages and apps need totally different URL strategies. Mix them up and you break SEO — or create absurd edge cases nobody can answer."
---

I've shipped multilingual marketing sites, multilingual documentation, and multilingual back-office apps — sometimes for the same client, in the same year — and I keep watching the same mistake get made: teams pick one URL strategy for "internationalization" and apply it everywhere.
...
Some products live in both worlds. A public marketing site with a "Log in" button that transitions into an authenticated app is the most common shape I deal with, and the right answer is usually a clean subdomain split:
