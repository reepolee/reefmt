...
function print_help(): void {
	...
	console.error("  --out <dir>        Output dir             (default: ./src/public/images/responsive)");
...
async function main(): Promise<void> {
	...
	console.log(`✓ Done in ${secs}s — ${total_encoded} variant set(s) encoded across ${images.length} image(s)`);
