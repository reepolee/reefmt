...
export const schema = z.object({
	...
	title: z.string().min(1, "title_required").max(30, "title_max"),
	equipment_code: z.string().min(1, "must_be_selected"),
	cena: z.nullable(z.coerce.number().optional()),
	kratica: z.nullable(z.string().max(10, "kratica_max").optional()),
});
