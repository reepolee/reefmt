...
fn format_script_content(content: &str, wrap_width: usize, collapse: crate::format::CollapseConfig, remove_unused: bool) -> String {
    ...
    let mut out = if collapse.enabled {
        crate::format::collapse_single_stmt_blocks(&out, wrap_width, &collapse)
    } else {
        out
    };
...
mod tests {
    use super::*;
    use crate::format::CollapseConfig;
